...
import static com.leuters.qqh.utils.ScreenUtil.dp2px;
...
public class GlideImageLoader extends ImageLoader {
    ...
    public void displayImage(Context context, Object path, ImageView imageView) {
        ...
        //Glide 加载图片简单用法
        setImg(context, bannerBean.imageURL, imageView, R.mipmap.icon_banner_default, R.mipmap.icon_banner_default);
    }
