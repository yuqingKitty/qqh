package com.leuters.qqh.ui.customview.swipeback;
...
public class SwipeBackHelper extends Handler {
    ...
    private SwipeBackHelper.ViewManager mViewManager;
     ...
     */
    public SwipeBackHelper(SwipeBackHelper.SlideBackManager slideBackManager) {
        ...
        mViewManager = new SwipeBackHelper.ViewManager();
    ...
    private class ViewManager {
        ...
        private boolean addViewFromPreviousActivity() {
            ...
            if(mPreviousActivity instanceof SwipeBackHelper.SlideBackManager &&
                    !((SwipeBackHelper.SlideBackManager)mPreviousActivity).canBeSlideBack()) {
                mPreviousActivity = null;
                mPreviousContentView = null;
                return false;
            }
